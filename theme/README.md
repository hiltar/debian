...
`.-::---..                     tarmo@t480 
   ...
   :oo:.`             -+oo:    Host: 20L5CTO1WW ThinkPad T480 
 `+o/`    .::::::-.    .++-`   Kernel: 6.1.0-23-amd64 
`/s/    .yyyyyyyyyyo:   +o-`   Uptime: 47 mins 
`so     .ss       ohyo` :s-:   Packages: 2173 (dpkg), 15 (flatpak) 
`s/     .ss  h  m  myy/ /s``   Shell: bash 5.2.15 
`s:     `oo  s  m  Myy+-o:`    Resolution: 1920x1080, 1920x1080 
